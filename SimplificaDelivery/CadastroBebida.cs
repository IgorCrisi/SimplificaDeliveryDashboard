...
{
    public partial class CadastroBebida : Form
    {
        ...
        private async void submitEnter(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                {
                    string apiUrl = "http://localhost:3333/bebidas/create";
                    var data = new
                    {
                        nome = nomeTxt.Text,
                        valor = valortxt.Text,
                    };
                    await CreateBebida(apiUrl, data);
                    this.Close();
                }
            }
        }
        ...
        private async Task CreateBebida(string url, object data)
        {
